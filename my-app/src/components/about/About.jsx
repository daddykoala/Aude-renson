...
La "théorie", je la comprenais et la connaissais. Mais régulièrement, dans la pratique et la vie quotidienne, j'étais dépassée par la situation, les réactions de mes enfants et surtout les miennes.</p>
        <p>En <span className='content__bold'>2019</span>, j'ai découvert la <Link to='/parentalite-creative' className='content-red'>Parentalité Créative&#174;</Link> au cours d'un cycle d'ateliers <a  className='content__red'><Link to='/parent/#cycle'>"Vivre et Grandir Ensemble®"</Link></a> . S'est offert à moi une toute autre approche de l'accompagnement de l'enfant et une meilleure compréhension de moi-même.</p>
